        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/lara-cast/" aria-current="page" class="<?= urlIs('/lara-cast/index.php') ? 'bg-gray-900' : 'text-gray-300' ?> px-3 py-2 text-sm rounded-md  font-medium text-white">Home</a>
              <a href="/lara-cast/about" class="<?= urlIs('/lara-cast/about.php') ? 'bg-gray-900' : 'text-gray-300' ?>  text-white rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">About</a>
              <a href="/lara-cast/notes" class="<?= urlIs('/lara-cast/notes.php') ? 'bg-gray-900' : 'text-gray-300' ?>  text-white rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Notes</a>
              <a href="/lara-cast/contact" class="<?= urlIs('/lara-cast/contact.php') ? 'bg-gray-900' : 'text-gray-300' ?>  text-white rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Contact</a>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Mohammed AL-mndob</div>
            <div class="text-sm font-medium text-gray-400">mohammed@gmail.com</div>
          </div>
